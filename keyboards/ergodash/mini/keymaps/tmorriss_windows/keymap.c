...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT( \
    ...
    KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,      KC_DLR,                        KC_RSFT, KC_N,    KC_M,    KC_COMM, KC_DOT,     KC_UP, KC_PLUS, \
  ...
  [_LOWER] = LAYOUT( 
    ...
    KC_LSFT,  KC_6,     KC_7,    KC_8,    KC_9,     KC_0,  KC_DLR,                         KC_SPC, KC_DOWN, _______,    KC_LT,   KC_GT,   _______, KC_GRV, \
  ...
  * |------+------+------+------+------+------+---------------------------+------+------+------+------+------+------+------|
  * | Shift|   F6 |   F7 |   F8 |   F9 |  F10 |   $  |                    | Space|   1  |   2  |   3  |   .  |   _  |   /  |
  * |-------------+------+------+------+------+------+------+------+------+------+------+------+------+------+-------------|
  * |  Esc |  F11 |  F12 |  GUI |||||||| Muhen| Lower| Space|||||||| Enter| Raise|   0  ||||||||  GUI |      |      |      |
  * ,----------------------------------------------------------------------------------------------------------------------.
  */
  [_RAISE] = LAYOUT(
    ...
    KC_LSFT, KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,   KC_DLR,                       KC_SPC,   KC_1,    KC_2,    KC_3,  KC_DOT,   KC_UNDS,  KC_SLSH, \
    KC_ESC , KC_F11 , KC_F12,  KC_LGUI,          KC_MHEN,  LOWER , KC_SPC,        KC_ENT,RAISE ,   KC_0,            KC_RGUI,  _______, _______, _______  \
    ),

  /* Adjust
   * ,----------------------------------------------------------------------------------------------------------------------.
   * |      |      |      |  End |      |      |      |                    |      |      | Home |BriDow| BriUp|      |      |
   * |------+------+------+------+------+------+---------------------------+------+------+------+------+------+------+------|
   * |      | Home |      |      |      |      |      |                    |      |      |  End |VolDow| VolUp|      |      |
   * |------+------+------+------+------+------+---------------------------+------+------+------+------+------+------+------|
   * |      |      |      |      |      |      |      |                    |      |      |      |      |      |      |      |
   * |-------------+------+------+------+------+------+------+------+------+------+------+------+------+------+-------------|
   * |      |      |      |      ||||||||      |      |      ||||||||      |      |      ||||||||      |      |      |      |
   ...
   */
  [_ADJUST] = LAYOUT(
    _______, _______, _______, KC_END,  _______, _______,_______,                       _______, _______, KC_HOME, KC_BRID, KC_BRIU, _______, _______, \
    _______, KC_HOME, _______, _______, _______, _______,_______,                       _______, _______, KC_END, KC_VOLU, KC_VOLD, _______, _______, \
