...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |  Tab |   !  |   #  |  END |   $  |   %  |   `  |                    |Delete|   ^  |   &  |   (  |   )  |  Up  |   |  |
   * |------+------+------+------+------+------+------+--------------------+------+------+------+------+------+------+------|
   * |  Ctrl| Home |      |Delete| Right|   F4 |   [  |                    |   ]  | Left | Down |  Up  | Right|   :  |   +  |
   * |------+------+------+------+------+------+---------------------------+------+------+------+------+------+------+------|
  ...
  [_LOWER] = LAYOUT(
    ...
    KC_LCTL, KC_HOME, _______, KC_DEL,  KC_RGHT, KC_F4, KC_LBRC,                     KC_RBRC, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_COLN, KC_PLUS, \
  ...
  * |------+------+------+------+------+------+---------------------------+------+------+------+------+------+------+------|
  * | Shift|   F6 |   F7 |   F8 |   F9 |  F10 |  GUI |                    | Space|   1  |   2  |   3  |   .  |   _  |   /  |
  * |-------------+------+------+------+------+------+------+------+------+------+------+------+------+------+-------------|
  ...
  */
  ...
  [_ADJUST] = LAYOUT(
    ...
    _______, _______, _______, _______, _______, _______,_______,                       _______, _______, _______, KC_VOLD, KC_VOLU, _______, _______, \
