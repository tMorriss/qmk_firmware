...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |------+------+------+------+------+------+---------------------------+------+------+------+------+------+------+------|
   * | Shift|   6  |   7  |   8  |   9  |   0  |   $  |                    | Space| Down |      |   <  |   >  | Home |   `  |
   * |-------------+------+------+------+------+------+------+------+------+------+------+------+------+------+-------------|
   * |  Esc |   _  |  Alt |  GUI |||||||| Muhen| Lower| Space|||||||| Enter| Raise|Henkan||||||||  GUI | PgDn |  End | PgUp |
   * ,----------------------------------------------------------------------------------------------------------------------.
   */
  [_LOWER] = LAYOUT( 
    ...
    KC_LSFT,  KC_6,     KC_7,    KC_8,    KC_9,     KC_0,  KC_DLR,                         KC_SPC, KC_DOWN, _______,    KC_LT,   KC_GT,   KC_HOME, KC_GRV, \
    KC_ESC, KC_UNDS, KC_LALT, KC_LGUI,           KC_MHEN,   LOWER, KC_SPC,        KC_ENT,RAISE , KC_HENK,            KC_RGUI,  KC_PGDOWN, KC_END,   KC_PGUP  \
  ),
  ...
  * |------+------+------+------+------+------+---------------------------+------+------+------+------+------+------+------|
  * | Shift|   F6 |   F7 |   F8 |   F9 |  F10 |   $  |                    | Space|   1  |   2  |   3  |   .  | Home |   `  |
  * |-------------+------+------+------+------+------+------+------+------+------+------+------+------+------+-------------|
  * |  Esc |  F11 |  F12 |  GUI |||||||| Muhen| Lower| Space|||||||| Enter| Raise|   0  ||||||||  GUI | PgDn |  End | PgUp |
  * ,----------------------------------------------------------------------------------------------------------------------.
  */
  [_RAISE] = LAYOUT(
    ...
    KC_LSFT, KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,   KC_DLR,                       KC_SPC,   KC_1,    KC_2,    KC_3,  KC_DOT, KC_HOME, KC_GRV, \
    KC_ESC , KC_F11 , KC_F12,  KC_LGUI,          KC_MHEN,  LOWER , KC_SPC,        KC_ENT,RAISE ,   KC_0,            KC_RGUI,  KC_PGDOWN, KC_END,   KC_PGUP  \
    ),
